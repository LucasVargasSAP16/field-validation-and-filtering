 ...
 * @param allowedLetters Array of allowed letter characters
 * @param allowedNumbers Array of allowed numeric characters
 * @return The filtered string with letters preserved and numbers sorted
 */
fun fieldValidationAndFiltering(input: String, allowedLetters: Array<String>, allowedNumbers: Array<String>): String {
