 ...
 * 
 * - Parameter input: The input string to filter
 * - Parameter allowedLetters: Array of allowed letter characters
 * - Parameter allowedNumbers: Array of allowed numeric characters
 * - Returns: The filtered string with letters preserved and numbers sorted
 */
