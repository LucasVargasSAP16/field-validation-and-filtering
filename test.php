 ...
 * @param array $allowedLetters Array of allowed letter characters
 * @param array $allowedNumbers Array of allowed numeric characters
 * @return string The filtered string with letters preserved and numbers sorted
 */
