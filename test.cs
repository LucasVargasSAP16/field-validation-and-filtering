...
namespace FieldValidationAndFiltering
{
    /// <summary>
    ...
    /// 
    /// Rules:
    /// - Only letters from allowedLetters array should remain
    /// - Only numbers from allowedNumbers array should remain
    ...
    /// <param name="allowedLetters">Array of allowed letter characters</param>
    /// <param name="allowedNumbers">Array of allowed numeric characters</param>
    /// <returns>The filtered string with letters preserved and numbers sorted</returns>
    public class Test
    {
        public static string FieldValidationAndFiltering(string input, string[] allowedLetters, string[] allowedNumbers)
        {
            string[] result = {};
            // Your code goes here
